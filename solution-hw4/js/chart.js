...
function priceCaculation(){
    ...
    if (Input.glazingInput==="keep original"){
        finalPrice=(basePrice+glazingPrice.original) * packPriceFinal;
    }else if (Input.glazingInput=="sugar milk"){
         finalPrice=(basePrice+glazingPrice.sugar) * packPriceFinal;
    }else if(Input.glazingInput=="vanilla milk"){
         finalPrice=(basePrice+glazingPrice.vanilla) * packPriceFinal;
    }else if(Input.glazingInput=="double chocolate"){ 
          finalPrice=(basePrice+glazingPrice.double) * packPriceFinal;
